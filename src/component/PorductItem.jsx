  ...
  return (
    <div className='card md:w-96 bg-base-100 shadow-sm shadow-orange-200 border border-[#ffaa00] p-5 '>
        ...
        <div className="card-body">
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae voluptate tenetur ducimus sunt recusandae omnis consequatur obcaecati, voluptatum aspernatur quasi? Veniam, aliquid. Expedita nostrum consequatur autem architecto deserunt iste a!</p>
        </div>
        ...
        <div className="card-action mt-2 text-center ">
            <button className='btn btn-xl mt-4 btn-primary ' 
                disabled={quantity === 0}
